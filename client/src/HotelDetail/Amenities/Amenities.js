...
function Amenities({ amenities, HotelDetailCard }) {
  const amenitiesIconMap = {
    ...
    clothingIron: { text: 'Hand Iron', component: <IronIcon /> },
    parkingGarage: { text: 'Free Parking', component: <LocalParkingIcon /> },
    tVInRoom: { text: 'TV', component: <TvIcon /> },
    outdoorPool: { text: 'Outdoor Pool', component: <PoolIcon /> },
